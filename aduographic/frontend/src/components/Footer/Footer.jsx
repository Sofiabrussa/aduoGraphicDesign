    ...
    return (
        <Container fluid className="bg-dark p-0" id="Footer">
            <Row className="g-1 align-items-center py-2 mx-0">
                <Col xs={12} sm={6} md={2} className="text-center text-md-start">
                    <Image src="/footer/Identidad2024.png" alt="Logo de mi empresa" className="navbar-logo" height={40} fluid />
                </Col>
